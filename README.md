...
Code (`reference/`, `conformance/`, `trials/`): MIT, see [`LICENSE`](LICENSE). Specification and documentation: [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/). The four external counterexample inputs quoted in `conformance/cases.json` remain their authors' contributions, credited with links; they are not relicensed here.
